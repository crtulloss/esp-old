...
#define SLD_VITDECODER 0x04A /* <<--id-->> */
#define DEV_NAME "sld,vitdecoder"
...
int main(int argc, char * argv[])
{
	...
	ndev = probe(&espdevs, SLD_VITDECODER, DEV_NAME);
	if (ndev == 0) {
#ifndef __riscv
		printf("vitdecoder not found\n");
#else
		print_uart("vitdecoder not found\n");
#endif
		return 0;
	}
