...
contig_handle_t vitHW_lmem;   // Pointer to local view of contig memory
contig_handle_t vitHW_li_mem; // Pointer to input memory block
contig_handle_t vitHW_lo_mem; // Pointer to output memory block
