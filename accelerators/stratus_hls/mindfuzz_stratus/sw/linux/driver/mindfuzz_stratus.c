...
#define DRV_NAME	"mindfuzz_stratus"
...
struct mindfuzz_stratus_device {
...
static struct of_device_id mindfuzz_device_ids[] = {
	{
		.name = "SLD_MINDFUZZ_STRATUS",
	},
	{
		.name = "eb_101",
	},
	{
		.compatible = "sld,mindfuzz_stratus",
	},
	{ },
};
...
static inline struct mindfuzz_stratus_device *to_mindfuzz(struct esp_device *esp)
{
	return container_of(esp, struct mindfuzz_stratus_device, esp);
}

static void mindfuzz_prep_xfer(struct esp_device *esp, void *arg)
{
	struct mindfuzz_stratus_access *a = arg;
...
{
	/* struct mindfuzz_stratus_device *mindfuzz = to_mindfuzz(esp); */
	/* struct mindfuzz_stratus_access *a = arg; */
...
{
	struct mindfuzz_stratus_device *mindfuzz;
	struct esp_device *esp;
	int rc;
...
static struct esp_driver mindfuzz_driver = {
	...
	.ioctl_cm	= MINDFUZZ_STRATUS_IOC_ACCESS,
	.arg_size	= sizeof(struct mindfuzz_stratus_access),
};
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("mindfuzz_stratus driver");
