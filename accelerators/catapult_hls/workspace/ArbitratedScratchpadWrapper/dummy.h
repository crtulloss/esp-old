...
SC_MODULE (Dummy) {
        ...
        handshake("handshake")
    {
        ...
        scratchpad_wrapper.resp_port_01(resp_port_01);
        scratchpad_wrapper.req_port_02(req_port_02);
        scratchpad_wrapper.resp_port_02(resp_port_02);
    ...
    Connections::Combinational<rsp_t> resp_port_01;
    Connections::Combinational<req_t> req_port_02;
    Connections::Combinational<rsp_t> resp_port_02;
