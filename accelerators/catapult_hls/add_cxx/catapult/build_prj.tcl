...
set ACCELERATOR "add_accelerator_cxx"
set PLM_HEIGHT 1024
set PLM_WIDTH 64
...
# Add source files.
solution file add ../src/add_accelerator.cpp -type C++
...
if {$opt(hsynth)} {
    ...
    # Arrays
    directive set /$ACCELERATOR/core/plm_input1.data:rsc -MAP_TO_MODULE Xilinx_RAMS.BLOCK_DPRAM_RBW_DUAL
    directive set /$ACCELERATOR/core/plm_input2.data:rsc -MAP_TO_MODULE Xilinx_RAMS.BLOCK_DPRAM_RBW_DUAL
    directive set /$ACCELERATOR/core/plm_output.data:rsc -MAP_TO_MODULE Xilinx_RAMS.BLOCK_DPRAM_RBW_DUAL

    # Loops
    directive set /$ACCELERATOR/core/BATCH_LOOP -PIPELINE_INIT_INTERVAL 1

    # Loops performance tracing
    directive set /$ACCELERATOR/core/LOAD_CTRL_1_LOOP -ITERATIONS 1
    directive set /$ACCELERATOR/core/LOAD_CTRL_2_LOOP -ITERATIONS 1
    directive set /$ACCELERATOR/core/STORE_CTRL_LOOP -ITERATIONS 1
