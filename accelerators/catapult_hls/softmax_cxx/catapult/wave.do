...
add wave -noupdate -label conf_done_rsc_triosy_lz -radix hexadecimal /scverify_top/rtl/conf_done_rsc_triosy_lz
...
WaveRestoreCursors {{Cursor 1} {13328637 ps} 0}
...
update
WaveRestoreZoom {0 ps} {5984324 ps}
